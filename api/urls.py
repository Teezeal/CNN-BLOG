...
from .views import api_list_page, Api_list_page, api_detail_page, Api_detail_page, api_create_page, api_update_page, Api_create_page, API_LIST_PAGE, API_DETAIL_PAGE
...
urlpatterns = [
    ...
    path("class/retreive/<slug:slug>/", API_DETAIL_PAGE.as_view(), name="class-retreive"),
]